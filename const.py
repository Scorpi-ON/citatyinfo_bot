...
# fake = Faker()
# [print(a.user_agent()) for _ in range(10)]
USER_AGENTS = (
    ...
    'Mozilla/5.0 (X11; Linux x86_64; rv:1.9.6.20) Gecko/2016-04-03 14:58:58 '
        'Firefox/15.0',
    'Mozilla/5.0 (Windows NT 6.0; oc-FR; rv:1.9.2.20) Gecko/2013-11-14 20:34:'
        '54 Firefox/10.0',
    'Mozilla/5.0 (Windows 98; Win 9x 4.90; sid-ET; rv:1.9.2.20) Gecko/2014-07-'
        '03 15:19:24 Firefox/3.8',
    'Mozilla/5.0 (Windows NT 5.2) AppleWebKit/535.2 (KHTML, like Gecko) Chrome'
        '/25.0.810.0 Safari/535.2',
    'Mozilla/5.0 (X11; Linux i686) AppleWebKit/531.1 (KHTML, like Gecko) '
        'Chrome/32.0.817.0 Safari/531.1',
    'Mozilla/5.0 (Windows 98; Win 9x 4.90; kn-IN; rv:1.9.2.20) Gecko/2011-08-'
        '18 15:14:46 Firefox/3.6.18',
    'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/535.1 (KHTML, like Gecko) '
        'Chrome/35.0.891.0 Safari/535.1',
    'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/531.2 (KHTML, like Gecko) '
        'Chrome/26.0.880.0 Safari/531.2',
    'Mozilla/5.0 (Macintosh; PPC Mac OS X 10 10_4 rv:2.0; cmn-TW) AppleWebKit/'
        '535.3.4 (KHTML, like Gecko) Version/5.0 Safari/535.3.4',
    'Mozilla/5.0 (Macintosh; Intel Mac OS X 10 6_8 rv:3.0; st-ZA) AppleWebKit/'
        '532.43.1 (KHTML, like Gecko) Version/4.0.5 Safari/532.43.1',
    'Mozilla/5.0 (iPad; CPU iPad OS 14_2_1 like Mac OS X) AppleWebKit/531.0 '
        '(KHTML, like Gecko) CriOS/35.0.871.0 Mobile/65L777 Safari/531.0',
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10 12_3 rv:2.0; gl-ES) AppleWeb'
        'Kit/532.49.1 (KHTML, like Gecko) Version/5.0.4 Safari/532.49.1',
